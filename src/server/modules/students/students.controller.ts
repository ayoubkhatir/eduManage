...
class StudentsController {
  ...
  async addStudent(data: AddStudentType) {
    ...
    try {
      ...
      const studentUser: StudentUser = StudentUserDto(
        student,
        student.user,
        student.class,
        student.class.grade,
  ...
  async editStudent(data: EditStudentType) {
    ...
    const studentWithUser: StudentUser = StudentUserDto(
      student,
      student.user,
      student.class,
      student.class.grade,
  ...
  async getDashboardChart({ schoolId, period }: DashboardPeriod) {
    const now = new Date()
    ...
    const students = await this.db
      ...
      .where(
        and(
          gte(studentsTable.enrollmentDate, startDateString),
