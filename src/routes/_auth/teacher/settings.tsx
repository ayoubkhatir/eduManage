...
function SettingsComp({ teacher }: { teacher: TeacherUser }) {
  ...
  return (
    <motion.main initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }} className="flex-1 overflow-y-auto p-4 md:p-6">
          ...
          >
            ...
            <div className="flex-1 space-y-6">
                ...
                <div className="space-y-5 p-6 md:p-8">
                  <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <input
                        className="h-11 w-full rounded-xl border border-border bg-card px-3 text-foreground outline-none transition-colors placeholder:text-muted-foreground focus:border-primary focus:ring-2 focus:ring-primary/20"
                        type="text"
                        placeholder="Name"
                        {...form.register('name')}
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex h-11 items-center justify-between rounded-xl border border-transparent bg-muted px-4 text-sm text-muted-foreground">
                    ...
                    <div className="space-y-2 md:col-span-2">
                      ...
                      <textarea
                        className="w-full resize-none rounded-xl border border-border bg-card p-3 text-foreground outline-none transition-colors placeholder:text-muted-foreground focus:border-primary focus:ring-2 focus:ring-primary/20"
                        rows={3}
              ...
              <section className="overflow-hidden rounded-2xl border border-border bg-card shadow-sm">
                ...
                <div className="grid grid-cols-1 gap-5 p-6 md:grid-cols-3 md:p-8">
                  <div className="space-y-2">
                    ...
                    <div className="flex h-11 items-center justify-between rounded-xl border border-transparent bg-muted px-4 font-mono text-sm text-muted-foreground">
              ...
              <div className="flex items-center justify-end gap-4 border-t border-border pt-6">
                <button
                  type="button"
                  className="cursor-pointer rounded-xl border border-border px-6 py-2.5 font-bold text-foreground transition-colors hover:bg-accent"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="cursor-pointer rounded-xl bg-primary px-6 py-2.5 font-bold text-white shadow-md transition-all hover:bg-primary/90 active:scale-[0.98] disabled:opacity-50"
                >
