        ...
        <div className="p-4 sm:p-5 space-y-5">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {statCards.map((card) => (
              <div
                key={card.label}
                className="rounded-lg border border-slate-100 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/50 p-3"
              >
                <div className="flex items-center gap-2 mb-2">
                  <div
                    className={`flex size-7 items-center justify-center rounded-lg ${card.color}`}
                  >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="space-y-3">
              <div className="rounded-xl border border-slate-100 dark:border-slate-700/50 bg-slate-50/30 dark:bg-slate-800/30 p-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {quickActions.map((action) => (
                    <div
                      key={action}
                      className="flex flex-col items-center justify-center gap-1 rounded-lg border border-slate-100 dark:border-slate-700/50 bg-white dark:bg-slate-800 p-2.5 transition-all hover:border-primary/30 hover:bg-primary/5"
                    >
              ...
              <div className="relative overflow-hidden rounded-xl bg-linear-to-br from-primary to-blue-700 p-4 shadow-md">
                ...
                <span className="material-symbols-outlined absolute -bottom-3 -right-3 text-6xl text-white/10">
                  dns
                </span>
              </div>
            </div>
                  ...
                  >
                    <td className="px-4 py-2.5">
                      <div className="flex items-center gap-2">
                        <div
                          className={`flex size-7 items-center justify-center rounded-full ${row.bg} ${row.text} text-[10px] font-bold`}
                        >
                          {row.initials}
                        </div>
                        <div>
                    ...
                    <td className="px-4 py-2.5">
                      <span
                        className={`inline-flex items-center rounded-full ${row.roleBg} ${row.roleText} px-2 py-0.5 text-[9px] font-medium`}
                      >
                        {row.role}
                      </span>
                    </td>
