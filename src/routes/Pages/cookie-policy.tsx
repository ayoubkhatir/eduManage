                ...
                <div className="mt-12 space-y-6 text-sm leading-relaxed text-slate-600 dark:text-slate-400 sm:text-base">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      ...
                      platform to function, including authentication and
                      security.
                    </li>
                    <li>
                  ...
                  <p>
                    We use limited third-party services (such as analytics
                    providers) that may set their own cookies. These services
