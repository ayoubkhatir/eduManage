              ...
              <div className="mx-auto max-w-3xl">
                ...
                <FadeIn delay={80}>
                  <div className="mt-12 space-y-6 text-sm leading-relaxed text-slate-600 dark:text-slate-400 sm:text-base">
                    ...
                    <p>
                      By accessing or using EduManage, you agree to be bound by
                    ...
                    <p>
                      EduManage provides a web-based school management platform
                      that includes features such as attendance tracking, grade
                      management, fee processing, and communication tools.
                    </p>
                    ...
                    <p>
                      ...
                      under your account. You agree to provide accurate
                    ...
                    <p>
                      ...
                      basis. Refunds are provided within 14 days of purchase for
                      annual plans. Monthly plans may be cancelled at any time.
                    </p>
                    ...
                    <p>
                      EduManage shall not be liable for any indirect,
                    ...
                    <p>
                      ...
                      for violation of these terms or for any other reason at
                      our discretion, with reasonable notice where possible.
                    </p>
                    ...
                    <p>
                      ...
                      <a
                        href="mailto:legal@edumanage.com"
