            ...
            <div className="mx-auto max-w-3xl">
              <FadeIn>
                <div className="text-center">
                  ...
                  <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">
                    Help us build the future of education technology. We&apos;re
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-3 text-sm text-slate-500 dark:text-slate-400">
                <span className="flex items-center gap-1">
                  <Icon name="public" className="text-base" /> Remote-friendly
                </span>
                <span className="flex items-center gap-1">
                  <Icon name="heart_plus" className="text-base" /> Great
                  benefits
                </span>
                <span className="flex items-center gap-1">
                  <Icon name="trending_up" className="text-base" /> Growth
                  opportunities
                </span>
              </div>
              ...
              <FadeIn delay={200}>
                <div className="mt-12 rounded-2xl border border-slate-200/80 bg-slate-50/50 p-8 text-center dark:border-white/6border-white/[0.06] dark:bg-white/2">
                  ...
                  <a
                    href="mailto:careers@edumanage.com"
